...
public:
    ...
    static uint32_t codeSWPowerDown()
    {
        return codeCommand(0x8);
    }

    static uint32_t codeInitialize()
    {
    ...
    static uint32_t codeSelectRefMid()
    {
        return codeCommand(0xB);
    }
    static uint32_t codeSelectRefM()
    {
        return codeCommand(0xC);
    }
    static uint32_t codeSelectRefP()
    {
    ...
    static uint32_t codeReadFIFO()
    {
        return codeCommand(0xE);
    }
    static uint32_t codeConfigDefault()
    {
        return codeCommand(0xF);
    }

    static uint32_t fullScaleUSB()
    {
        return (0x1<<NBIT)-1;
    }
